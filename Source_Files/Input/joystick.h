...
#ifdef __SWITCH__
const int AO_DEFAULT_CONFIRM_CONTROLLER_BUTTON = SDL_CONTROLLER_BUTTON_B;
const int AO_DEFAULT_CANCEL_CONTROLLER_BUTTON = SDL_CONTROLLER_BUTTON_A;
#else
const int AO_DEFAULT_CONFIRM_CONTROLLER_BUTTON = SDL_CONTROLLER_BUTTON_A;
const int AO_DEFAULT_CANCEL_CONTROLLER_BUTTON = SDL_CONTROLLER_BUTTON_B;
#endif
